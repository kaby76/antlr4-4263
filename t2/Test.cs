...
{
    public static InstrukciyaImportirovatParser Parser { get; set; }
    ...
    public static string StartSymbol { get; set; } = "importirovatInstrukciyaChereda";
    public static string Input { get; set; }
    public static void SetupParse2(string input, bool quiet = false)
    {
        ICharStream str = new AntlrInputStream(input);
        CharStream = str;
        var lexer = new InstrukciyaImportirovatLexer(str);
        Lexer = lexer;
        var tokens = new CommonTokenStream(lexer);
        TokenStream = tokens;
        var parser = new InstrukciyaImportirovatParser(tokens);
        Parser = parser;
    ...
    {
        var tree = Parser.importirovatInstrukciyaChereda();
